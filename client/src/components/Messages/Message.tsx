...
const Message = ({read}:{read:boolean}) => {
  return (
    <div className={`h-20 w-full rounded-2xl flex flex-row items-center py-2 px-3 space-x-2 duration-100 transition ${!read ? 'bg-white' :'hover:bg-white hover:bg-opacity-70'}`}>
